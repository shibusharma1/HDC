...
<div class="table-container">
    <div class="table-title" style="display: flex; align-items: center; justify-content: space-between;">
        ...
        if ($scount > 0) {
            ...
            <form action="hideresults.php" method="POST" style="margin-left: auto;">
                <button type="submit" name="hideresults" class="delete-button"
        ...
        <?php
            ...
            <form action="showresults.php" method="POST" style="margin-left: auto;">
                <button type="submit" name="showresults" class="delete-button"
    ...
    <div class="table-content">
        ...
        <?php
        $sql = "SELECT * FROM vote_status";
        $sresults = mysqli_query($conn, $sql);
        $scount = mysqli_num_rows($sresults);
        if ($scount == 0) {
            ?>
            <a href="report.php" id="downloadBtn" target="_blank"> <i class="fa-solid fa-rotate-right"
                    style="padding-right:5px;"></i>Generate Report</a>
