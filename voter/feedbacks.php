...
<div class="feedback-container"
    style="display: grid; grid-template-columns: 1fr 1fr; max-width: 900px; margin: 20px auto; padding: 20px; background: #f9f9f9; border: 1px solid #ddd; border-radius: 8px;">
    ...
    <div class="feedback-info" style="border-right:3px solid #01529D;" >
